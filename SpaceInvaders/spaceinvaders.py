...
class Block(pygame.sprite.Sprite):
    ...
    def __init__(self, color = BLACK, size = 12):
        """
...
class Invader(pygame.sprite.Sprite):
    ...
    def shoot(self):
        ...
        """
        bullet = Bullet(self.rect.midtop, -1, speed = 1, color = RED)
        return bullet
...
class Bullet(pygame.sprite.Sprite):
    ...
    def __init__(self, pos_xy, direction, color = WHITE, speed = 12):
        """
...
class SpaceInvaders():
    ...
    def home_screen(self):
        ...
        text = self.font.render("Space Invaders", True, RED)
